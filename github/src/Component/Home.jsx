...
// const Home = () => {
//     return (
//         <div className='border border-black w-full h- box-border'>

//             <div className='border border-black w-full h-128 bg-[url(https://images8.alphacoders.com/394/394958.jpg)] bg-cover bg-no-repeat'>
//             </div>
...
//                  Navbar
//                 <div className='w-11/12 m-auto pt-3 h-128 flex justify-between'>
...
//                     <div className='border border-black w-11/12 h-96 m-auto flex justify-between'>
...
//                 </div>
//                 section two
//                 <div className='border border-black w-11/12'>
