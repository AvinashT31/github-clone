    ...
    return (
        <div className='border border-black  w-full h-screen'>
            <div className='border border-black w-full h-16'>
                <div className='w-11/12 m-auto mt-2 h-11 flex justify-between'>
                    ...
                    <div className='w-2/5 h-full flex'>
                        <div className='border border-black w-60 h-8 mt-1 flex rounded-xl'>
                            <input className='w-40 border-none outline-none ml-2' type="text" placeholder='Search Github' />
                        </div>
                        <div className='w-16 h-full ml-2'>
                            <p className='mt-1'>Sign in</p>
                        </div>
                        <div className='border border-black w-16 h-8 mt-1 rounded-xl ml-2'>
                            <p>Sign up</p>
                        </div>
